const HeroSection = () => {
  return (
    <div className=" w-[100%] items-center justify-start shadow-md h-full text-white" style={{ background: "#2B4263" }}>
      <div className="flex justify-between px-8 py-2 border-b border-blue-900">
        ...
        <div className="my-auto text-xl font-bold">
          <button className="border-2 mr-4 px-4" style={{ borderRadius: "18px" }}>Login</button>
          <button className="border-2 px-4" style={{ borderRadius: "18px" }}>Signup</button>
        </div>
      </div>
